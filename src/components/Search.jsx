...
const Search = () => {
    return (
        <div className='bg-gray-100 rounded-full flex items-center gap-2 px-2'>
            ...
            <input type='text' placeholder='Search posts' className='bg-transparent p-2 rounded-full outline-none' />
        </div>
    )
}
